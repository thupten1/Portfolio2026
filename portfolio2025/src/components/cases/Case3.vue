...
<template>
  <section class="big-screen">
    ...
    <div class="case-text">
      <p>This project showcases a complete webshop I designed and developed for Gebr Opdam, an automotive company specializing in new and secondhand car parts. From the first sketches to the final front-end implementation, I took full ownership of the process—combining UX design, front-end development, and direct client collaboration to deliver a clean, modern, and user-friendly online experience.</p>
    </div>
    <div v-if="showImage" class="projectimg" :style="{ left: imgPosition.left, top: imgPosition.top}">
      <img src="../../assets/images/opdam/iPhone16Pro.png" alt="Project Preview">
    </div>
  </div>
</section>
  
<section class="mobile">
  <div class="case" id="Opdam" @click= gotoproject>
    <div class="case-boxes">
      <div class="case-boxes_row">
        <div class="case-box1"> 
          <p class="case-box1__text">3.</p>
      ...
      <div class="case-boxes_row">
        <div class="m-case-box1">
          <p class="case-box1__text">UX/UI Design<br/>Front-end Development<br/>Project Management</p>
        </div>
