    ...
    <div class="case" id="ikea" 
      ...
      <div class="case-boxes">
        ...
        <div class="case-boxes_row">
          ...
          <div class="case-box2">
            <p class="case-box2__text">Concepting<br/>UI/UX Design<br/>UX Research<br/> Development</p>
          </div>
          <div class="case-box3">
            <p></p>
          </div>
      ...
      <div v-if="showImage" class="projectimg" :style="{ left: imgPosition.left, top: imgPosition.top}">
        <img src="../../assets/images/Ikea/iPad Pro.png" style="object-position: center;" alt="Project Preview">
      </div>
    </div>
  </section>

  <section class="mobile">
    <div class="case" id="ikea" @click="gotoproject">
      <div class="case-boxes">
        <div class="case-boxes_row">
          <div class="case-box1"> 
            <p class="case-box1__text">1.</p>
        ...
        <div class="case-boxes_row">
          <div class="m-case-box1">
            <p class="m-case-box1__text">Concepting<br/>UI/UX Design<br/>UX Research<br/> Development</p>
          </div>
